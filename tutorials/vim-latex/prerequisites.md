...
You should be comfortable using Vim/Neovim's excellent built-in documentation, which you access with the `:help` command.
...
- There are so few needed for this series that we can just list them here.
  The abbreviations you should know are:
